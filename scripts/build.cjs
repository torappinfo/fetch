...
try {
    esbuild.build({
        ...
        fs.copyFileSync('.zeabur/output/functions/index.func/express.cjs', '.zeabur/output/functions/index.func/index.cjs');
        fs.rmSync('.zeabur/output/functions/index.func/express.cjs')
    })
} catch (error) {
    console.error(error)
}
