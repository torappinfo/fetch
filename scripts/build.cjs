...
try {
    esbuild.build({
        ...
        fs.copyFileSync('.zeabur/output/functions/index.func/render.js', '.zeabur/output/functions/index.func/index.js');
        fs.rmSync('.zeabur/output/functions/index.func/render.js')
    })
} catch (error) {
    console.error(error)
}
